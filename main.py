    ...
    def build_graph(self, image, label):
        ...
        with argscope(Conv2D, activation=BNReLU, use_bias=False):
            ...
            br1 = (LinearWrap(l)
                   ...
                   .FullyConnected('loss1logit', 5000, activation=tf.identity)())
            ...
            br2 = FullyConnected('loss2logit', br2, 5000, activation=tf.identity)
            ...
            logits = FullyConnected('linear', l, 5000, activation=tf.identity)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpu', default='0,1,3,4', help='comma separated list of GPU(s) to use.')
